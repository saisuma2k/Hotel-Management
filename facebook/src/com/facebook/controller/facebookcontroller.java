...
public class facebookcontroller implements facebookcontrollerinterface {
	...
	public int editprofilecntroller() {
		...
		System.out.println("enter your address tht you want to edit");
...
facebookuser fu=new facebookuser();
	...
	public int searchprofilecontroller() {
        ...
        facebookuser fu=new facebookuser();
        facebookserviceinterface fi= servicefactory.createobject();
		int f1= fi.searchprofileservice(fu);
		...
		{
			System.out.println("profile not searched");
	...
	public facebookuser signincontroller() {
		...
		facebookuser s2=fi.viewprofileservice(fu);
